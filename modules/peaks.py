...
def extract_top_peaks(
    ...
    *,
    ...
    """Extract top-N strongest peaks and their approximate ranges.

    - `mode="max"`: treat peaks as local maxima of `y`
    - `mode="min"`: treat peaks as local minima of `y` (absorption dips), implemented via maxima of `-y`
    - `mode="auto"`: choose between max/min by total prominence
    """
